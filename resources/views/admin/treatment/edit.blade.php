        ...
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form class="mb-6" action="{{ route('admin.treatment.update',$client->id) }}" method="POST">
            ...
            <div class="flex flex-col mb-4">
              ...
              <input class="border py-2 px-3 text-grey-darkest" type="text" name="content" id="content" value="{{$treatment->content}}">
            </div>
            <div class="flex flex-col mb-4">
              <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="point">注意点</label>
              <input class="border py-2 px-3 text-grey-darkest" type="text" name="point" id="point" value="{{$treatment->point}}">
            </div>
