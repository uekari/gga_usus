              ...
              <div class="form-group row">
                <div class="col-md-6">
                  <div class="form-check form-check-inline">
                    <input class="form-check-input mr-2" type="radio" name="is_move" id="is_move1" value="1">移動あり
                    <input class="form-check-input mr-2" type="radio" name="is_move" id="is_move2" value="2">移動なし
                  </div>
                </div>
              </div>
            </div>
