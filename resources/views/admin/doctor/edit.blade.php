        ...
        <div class="py-12  px-16 bg-white ">
          ...
          <form class="mb-6" action="{{ route('admin.doctor.update',$doctor->id) }}" method="POST">
            ...
            <div class="flex items-center mb-8 text-gray-900">
              ...
              <input class="flex-auto border border-1 border-gray-300 py-2 px-3" type="text" name="doctor_name" id="doctor_name" value="{{$doctor->doctor_name}}">
            </div>
            <div class="flex items-center mb-8 text-gray-900">
              <label class="w-32" for="belong">病院名</label>
              <input class="flex-auto border border-1 border-gray-300 py-2 px-3" type="text" name="belong" id="belong" value="{{$doctor->belong}}">
            </div>
            <div class="flex items-center mb-8 text-gray-900">
              <label class="w-32" for="address">住所</label>
              <input class="flex-auto border border-1 border-gray-300 py-2 px-3" type="text" name="address" id="address" value="{{$doctor->address}}">
            </div>
            <div class="flex items-center mb-8 text-gray-900">
              <label class="w-32" for="tel">電話番号</label>
              <input class="flex-auto border border-1 border-gray-300 py-2 px-3" type="text" name="tel" id="tel" value="{{$doctor->tel}}">
            </div>
            <div class="flex items-center mb-8 text-gray-900">
              <label class="w-32" for="fax">FAX番号</label>
              <input class="flex-auto border border-1 border-gray-300 py-2 px-3" type="text" name="fax" id="fax" value="{{$doctor->fax}}">
            </div>
