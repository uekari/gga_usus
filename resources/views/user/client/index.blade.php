          ...
          <section class="text-gray-900 body-font">
            ...
            <div class="w-full mx-auto overflow-auto mb-4">
              ...
              <div class="flex flex-col mb-4">
                ...
                <p class="pb-3 border-b border-1 border-gray-400">{{ $doctor->doctor_name}}</p>
              </div>
              <div class="flex flex-col mb-4">
                <p class="mb-2 text-sm">かかりつけ病院</p>
                <p class="pb-3 border-b border-1 border-gray-400">{{ $doctor->belong}}</p>
              </div>
              @endforeach
              @foreach ($caremanagers as $caremanager)
              <div class="flex flex-col mb-4">
                <p class="mb-2 text-sm">担当ケアマネ</p>
                <p class="pb-3 border-b border-1 border-gray-400">{{ $caremanager->caremanager_name}}</p>
              </div>
              <div class="flex flex-col mb-4">
                <p class="mb-2 text-sm">担当事業所</p>
                <p class="pb-3 border-b border-1 border-gray-400">{{ $caremanager->belong}}</p>
              </div>
              @endforeach
