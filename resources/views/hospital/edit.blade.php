    ...
    <div class="max-w-7xl mx-auto sm:w-8/12 md:w-1/2 lg:w-5/12">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form class="mb-6" action="{{ route('hospital.update',$hospital->id) }}" method="POST">
            @method('put')
            @csrf
            ...
            <div class="flex flex-col mb-4">
              ...
              <input class="border py-2 px-3 text-grey-darkest" type="text" name="description" id="description" value="{{$hospital->description}}">
            </div>
